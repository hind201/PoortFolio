...
if (!empty($_POST)){
$update = "UPDATE fil_rouge_portfolio SET photo='".$_POST["photo"]."'  where id=8";
mysqli_query($connection,$update);

$sqlmodification = mysqli_query($connection, "SELECT  photo From fil_rouge_portfolio where id=8 ");
...
<textarea type="text"  name="paragraphe"  value="<?php echo $row['parag'];?>" placeholder="changer la paragraphe"></textarea>	
  ...
  <div class="form-input">
<label>photo</label>
<input type="file"  name="photo"  value="<?php echo $row1['photo'];?>" placeholder="changer la photo">
            </div>
